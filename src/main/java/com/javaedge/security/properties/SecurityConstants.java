...
public interface SecurityConstants {
    ...
    /**
     * qq appID
     * TODO: 需要自己申请,这里使用 spring4all 提供的
     */
    ...
    /**
     *自定义社交 social 拦截地址  默认/auth  (SocialAuthenticationFilter)
     */
     ...
     */
    String DEFAULT_PARAMETER_CODE_IMAGE = "imageCode";

    /**
     * 验证短信验证码时，http请求中默认的携带短信验证码信息的参数的名称
     */
    String DEFAULT_PARAMETER_CODE_SMS = "smsCode";

    /**
     * 发送短信验证码 或 验证短信验证码时，传递手机号的参数的名称
     */
    String DEFAULT_PARAMETER_MOBILE = "mobile";
